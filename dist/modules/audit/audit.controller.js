...
let AuditController = class AuditController {
    ...
    findAll(user, pagination, entity, entityId, clinicId) {
        return this.auditService.findAuditLogs((0, tenant_util_1.resolveClinicId)(user, clinicId), {
            entity,
            entityId,
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)('audit.read'),
