...
let AuditService = AuditService_1 = class AuditService {
    ...
    activity(user, clinicId, action, detail = {}) {
        this.prisma.activityLog
            ...
            .catch((err) => this.logger.error(`Activity write failed: ${err.message}`));
    }
    async findAuditLogs(clinicId, filters) {
        const where = {
            clinicId,
