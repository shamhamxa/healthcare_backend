...
export declare class PrescriptionsService {
    ...
    private frequencyString;
    upsertForVisit(user: AuthenticatedUser, visitId: string, dto: UpsertPrescriptionDto): Promise<{
        items: {
            id: string;
            sortOrder: number;
    ...
    findByVisit(user: AuthenticatedUser, visitId: string): Promise<{
        patient: {
            mrn: string;
            id: string;
            fullName: string;
    ...
    printPayload(user: AuthenticatedUser, visitId: string): Promise<{
        clinic: {
            email: string | null;
            phone: string | null;
            name: string;
